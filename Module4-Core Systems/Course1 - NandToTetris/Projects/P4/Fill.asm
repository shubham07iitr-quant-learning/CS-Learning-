...
//we will check value of KBD if it is 0 or not
@KBD 
D=M //D register now has 24576
//We will jump back to blacken, when D not equal to 0
@BLACKEN
D;JNE

//If KBD is equal to 0, then we will clear the screen
...
//AND NOW WE WILL JUMP TO THE TOP AFTER WHITENING OF SCREEN
@LISTEN
0;JMP
